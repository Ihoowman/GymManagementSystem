...
TrainerDialog2::TrainerDialog2(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::TrainerDialog2)
{
    ui->setupUi(this);
...
TrainerDialog2::~TrainerDialog2()
{
    delete ui;
}
void TrainerDialog2::search()
{
